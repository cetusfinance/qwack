...
namespace Qwack.Excel.Dates
{
    public class BusinessDateFunctions
    {
        ...
        [ExcelFunction(Description = "Adds a specified period to a date, adjusting for holidays", Category = "QDates", IsThreadSafe = Parallel)]
        ...
        [ExcelFunction(Description = "Subtracts a specified period from a date, adjusting for holidays", Category = "QDates", IsThreadSafe = Parallel)]
        ...
        [ExcelFunction(Description = "Returns N-th instance of a specific weekday in a given month", Category = "QDates", IsThreadSafe = Parallel)]
        ...
        [ExcelFunction(Description = "Returns N-th last instance of a specific weekday in a given month", Category = "QDates", IsThreadSafe = Parallel)]
        ...
        [ExcelFunction(Description = "Returns 3rd Wednesday in a given month", Category = "QDates", IsThreadSafe = Parallel)]
        ...
        [ExcelFunction(Description = "Returns year faction for two dates and a given day count method", Category = "QDates", IsThreadSafe = Parallel)]
        ...
        [ExcelFunction(Description = "Returns number of business days in a period for a give calendar", Category = "QDates", IsThreadSafe = Parallel)]
        ...
        [ExcelFunction(Description = "Returns start and end dates for a period code", Category = "QDates", IsThreadSafe = Parallel)]
        ...
        [ExcelFunction(Description = "Returns the last business day in a month for a give calendar", Category = "QDates", IsThreadSafe = Parallel)]
        ...
        [ExcelFunction(Description = "Returns the last calendar day in a month for a give calendar", Category = "QDates", IsThreadSafe = Parallel)]
        ...
        [ExcelFunction(Description = "Returns a list of all calendar names", Category = "QDates", IsThreadSafe = Parallel)]
        ...
        [ExcelFunction(Description = "Returns next isntance of specific weekday", Category = "QDates", IsThreadSafe = Parallel)]
        ...
        [ExcelFunction(Description = "Returns the spot date for a lag and calendar pair", Category = "QDates", IsThreadSafe = Parallel)]
        ...
        [ExcelFunction(Description = "Returns dates for Good Friday and Easter Monday in the given year", Category = "QDates", IsThreadSafe = Parallel)]
        ...
        [ExcelFunction(Description = "Lists holidays for a calendar between two dates", Category = "QDates", IsThreadSafe = Parallel)]
