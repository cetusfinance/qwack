...
namespace Qwack.Core.Instruments.Asset
{
    public static class AssetProductFactory
    {
        ...
        public static AsianLookbackOption CreateAsianLookbackOption(DateTime start, DateTime end, string assetId, OptionType putCall, Calendar fixingCalendar, DateTime payDate, Currency currency, DateTime[] fixingDates, TradeDirection tradeDirection = TradeDirection.Long, Frequency spotLag = new Frequency(), double notional = 1, DateGenerationType fixingDateType = DateGenerationType.BusinessDays, int windowSize=1)
        {
        ...
        public static AsianLookbackOption CreateAsianLookbackOption(DateTime start, DateTime end, string assetId, OptionType putCall, Calendar fixingCalendar, DateTime payDate, Currency currency, TradeDirection tradeDirection = TradeDirection.Long, Frequency spotLag = new Frequency(), double notional = 1, DateGenerationType fixingDateType = DateGenerationType.BusinessDays, int windowSize = 1)
        {
            var fixingDates = fixingDateType == DateGenerationType.BusinessDays ?
                    start.BusinessDaysInPeriod(end, fixingCalendar) :
                    start.FridaysInPeriod(end, fixingCalendar);
            return CreateAsianLookbackOption(start, end, assetId, putCall, fixingCalendar, payDate, currency, fixingDates.ToArray(), tradeDirection, spotLag, notional, fixingDateType, windowSize);
        }
        public static AsianLookbackOption CreateAsianLookbackOption(DateTime start, DateTime end, string assetId, OptionType putCall, Calendar fixingCalendar, Calendar payCalendar, Frequency payOffset, Currency currency, TradeDirection tradeDirection = TradeDirection.Long, Frequency spotLag = new Frequency(), double notional = 1, DateGenerationType fixingDateType = DateGenerationType.BusinessDays)
        {
        ...
        public static MultiPeriodBackpricingOption CreateMultiPeriodBackPricingOption(Tuple<DateTime, DateTime>[] periodDates, DateTime decision, string assetId, OptionType putCall, Calendar fixingCalendar, DateTime payDate, Currency currency, TradeDirection tradeDirection = TradeDirection.Long, Frequency spotLag = new Frequency(), double notional = 1, DateGenerationType fixingDateType = DateGenerationType.BusinessDays, bool isOption = false, DateShifter fixingOffset = null )
        {
            var fixingDates = fixingDateType == DateGenerationType.BusinessDays ?
            ...
            return CreateMultiPeriodBackPricingOption(periodDates, fixingDates, decision, assetId, putCall, fixingCalendar, payDate, currency, tradeDirection, spotLag, notional, fixingDateType, isOption, fixingOffset);
        }
