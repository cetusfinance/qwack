...
namespace Qwack.Core.Instruments
{
    public static class InstrumentFactory
    {
        ...
        private static AsianSwap GetAsianSwap(this TO_AsianSwap transportObject, ICurrencyProvider currencyProvider, ICalendarProvider calendarProvider) => new AsianSwap
        {
            ...
            FixingCalendar = calendarProvider.GetCalendar(transportObject.FixingCalendar),
            PaymentCalendar = calendarProvider.GetCalendar(transportObject.PaymentCalendar),
            ...
            PaymentCurrency = currencyProvider.GetCurrency(transportObject.PaymentCurrency),
