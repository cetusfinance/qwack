...
namespace Qwack.Models.Models
{
    public interface IPnLAttributor
    {
        ...
        ICube ExplainAttribution(Portfolio portfolioStart, Portfolio portfolioEnd, IAssetFxModel startModel, IAssetFxModel endModel, Currency ccy, ICurrencyProvider ccyProvider);
        ICube ExplainAttributionInLineGreeks(Portfolio portfolio, IAssetFxModel startModel, IAssetFxModel endModel, Currency ccy, ICurrencyProvider ccyProvider);
    }
}