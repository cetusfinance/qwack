...
{
    public class MultiFutureEstimator(string assetId, IAssetFxModel vanillaModel, DateTime valDate, DateTime[] averageDates, DateShifter dateShifter = null) : IForwardPriceEstimate
    {
