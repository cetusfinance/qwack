...
namespace Qwack.Random.Sobol
{
    ...
    {
        private static readonly SobolDirectionInfo[] _allDimensions = (new SobolDirectionNumbersEncoded()).AllDimensions;
        ...
        public SobolDirectionNumbers() { }// => _allDimensions = (new SobolDirectionNumbersEncoded()).AllDimensions; // LoadFromResource();
