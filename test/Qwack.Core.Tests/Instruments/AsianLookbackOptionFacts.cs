...
{
    public class AsianLookbackOptionFacts
    {
        [Fact]
        public void AsianLookbackOptionFact()
        {
            ...
            var x2 = new AsianLookbackOption()
            {
                AssetId = "QS",
                CallPut = OptionType.C,
                DiscountCurve = "X",
            ...
            y.AssetId = "USD/ZAR";
            Assert.Equal(y.AssetId, y.FxPair(fakeModel.Object));
