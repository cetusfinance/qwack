...
namespace Qwack.Math.Tests.Solvers
{
    public class Halley1dFacts
    {
        ...
        private double QuadraticFunction1dSecondDerivative(double input)
        {
            var x = input;
            var y = 2;
            return y;
        ...
        {
            var output = Math.Solvers.Halley1d.MethodSolve(QuadraticFunction1d, 10, 1e-8);
        ...
        {
            var output = Math.Solvers.Halley1d.MethodSolve(QuadraticFunction1d, QuadraticFunction1dDerivative, QuadraticFunction1dSecondDerivative, 10, 1e-8);
            var functionOutput = QuadraticFunction1d(output);
            Assert.Equal(0, functionOutput, 8);
        }
    }
